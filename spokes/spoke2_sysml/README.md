...
> **Ecosystem Dependency**: Imports `crate_encoder` and `counterfactual_engine` from `pcos_core_engine` (Code overlap < 10%)
...
## Key Files
- `models/PCOS_Safety_MBSE.sysml`: Formal SysML v2.0 textual modeling specification for the PCOS NeSy Sentinel.
